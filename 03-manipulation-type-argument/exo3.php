...
class Pompe
{
    ...
    public function donneEssence (Vehicule $v) {    // > reçoit dc un objet de la classe véhicule en argument !!
...
$p -> donneEssence($v);      // je passe entièrement l'objet vehicule à la fct

...
echo '<pre>';
var_dump($panier1);     // ⚠️ => return + d'info que print_r
        /*  object(Panier)#1 (1) {      (#1 = 1er panier / (1) = qu'une propriété)
            ["nbProduit"]=>
            NULL   */
print_r(get_class_methods($panier1));   
// => return un array ; à l'indice 0 = retourne la méthode public ajouterPdt
        /*  Array
            (
                [0] => ajouterProduit
            )   */
...
$panier1 -> nbProduit = 5;
//⚠️  Affectation de la valeur 5 dans la propriété nbProduit de Panier1
...
// pr accéder à 1 propriété pas de '$' / ⚠️ ' -> ' = j'accède à ...
...
// Nous avons affecté une valeur à nbProduit de Panier 1... 
// Cela n'a pas d'incidence sur Panier2 pour lequel la valeur nbProduit reste Null!
...
/*****************⚠️ COMMENTAIRES ⚠️*******************
    ...
    ⚠️ 'new' est 1 mot clé qui permet de créer un objet issu d'une classe. 
    ⚠️ ️ On parle d'instanciation
    ...
    ⚠️ On peut créer plusieurs objets issus d'une même classe.
